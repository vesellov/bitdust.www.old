...
$(document).ready(function(e) {
	...
	*************************/
	$('.screenshots img').each(function(index, element) {
		...
		myImg.load(function(e) {
			img_loaded += 1;;
			if ( img_loaded == $('.screenshots img').length ) {
...
jQuery(document).ready(function ($) {
	...
	function goToByScroll(dataslide) {
		var offset_top = ( dataslide == 1 ) ? '0px' : $('.slide[data-slide="' + dataslide + '"]').offset().top - 50;
...
jQuery(document).ready(function ($) {
	//Cache some variables
	var images = $('.screenshots a.fancybox');
